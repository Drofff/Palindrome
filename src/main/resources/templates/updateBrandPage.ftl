<html>
<head>
    <title>Palindrome - Update Brand <#if brand.name??>${brand.name}</#if></title>
        ...
        <div class="page-content">
            <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 10%; margin-top: 2%;">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Редагувати марку</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <form action="/admin/brand/update/${brand.id}" method="post">

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" <#if brand.name??>value="${brand.name}" </#if> autocomplete="off" id="name" name="name" type="text">
                            <label class="mdl-textfield__label" for="name">Назва марки</label>
                        </div>
