<html>
<head>
    <title>Palindrome - Update Violation Type <#if violationType.name??>${violationType.name}</#if></title>
        ...
        <div class="page-content">
            <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 10%; margin-top: 2%;">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Редагувати тип порушення</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <form id="violation-type-form" action="/admin/violation-type/update/${violationType.id}" method="post">

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" <#if violationType.name??>value="${violationType.name}" </#if> autocomplete="off" id="name" name="name" type="text">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" <#if violationType.fee.amount??>value="${(violationType.fee.amount / 100)?c}"
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <select class="mdl-textfield__input" id="feeCurrency" name="feeCurrency">
                                <#list availableCurrencies as currency>
                                    <option <#if violationType.fee.currency?? && violationType.fee.currency == currency>selected</#if> value="${currency}">${currency}</option>
                                </#list>
                            </select>
