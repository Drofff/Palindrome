<html>
<head>
    <title>Palindrome - Licence Categories</title>
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
            ...
            <a href="/admin/licence-category" class="mdl-layout__tab is-active">Категорії автомобілів</a>
    ...
    <main class="mdl-layout__content">
        <div class="page-content">
            ...
            <div style="margin-left: 7%; margin-top: 3%;">
                <a class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" href="/admin/licence-category/create">
                    Створити
                </a>
            </div>

            <div style="margin-left: 9%; margin-top: 3%;">
                <#if licence_categories?size gt 0>
                    <ul class="demo-list-item mdl-list">
                        <#list licence_categories as licence_category>
                            <div class="demo-card-square mdl-card mdl-shadow--2dp">
                                <div class="mdl-card__supporting-text" style="text-align: right">
                                    <span class="material-icons" onclick="window.location.href='/admin/licence-category/update/${licence_category.id}'" style="cursor: pointer">
                                       create
                                   </span>
                                    <span class="material-icons" onclick="delete_licence_category('${licence_category.id}', '${licence_category.name}')" style="cursor: pointer; margin-left: 2%;">
                                        delete
                                    </span>
                                </div>
                                <div class="mdl-card__actions" style="height: 200px; text-align: center;">
                                    <h3>${licence_category.name}</h3>
                                </div>
                            </div>
                        </#list>
                    </ul>
...
<script>
    ...
    function delete_licence_category(id, name) {
        var result = window.confirm('Ви впевнені, що бажаєте видалити категорію \"' + name + "\"?");
        if(result) {
            var delete_uri = '/admin/licence-category/delete/' + id;
