<html>
<head>
	<title>Palindrome - Add Car</title>
	...
	<style>
		...
		.demo-card-wide > .mdl-card__title {
			color: #fff;
			height: 200px;
			background: url('https://ak9.picdn.net/shutterstock/videos/15428539/thumb/1.jpg') center / cover;
		}
	</style>
</head>
<body>
		...
		<div class="page-content">
			...
			<div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 22%; margin-top: 5%;">
				<div class="mdl-card__title">
					<h2 class="mdl-card__title-text">Інформація про автомобіль</h2>
				</div>
				<div class="mdl-card__supporting-text">
					<#if !success?? || !success>
						<form action="/car/create" method="post" style="margin-left: 5%;">

							<div id="general-info">
								<div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" <#if car?? && car.number??>value="${car.number}"</#if> type="text" name="number" id="number">
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" <#if car?? && car.bodyNumber??>value="${car.bodyNumber}"</#if> type="text" name="bodyNumber" id="bodyNumber">
								...
								<div>
									...
									<div class="mdl-textfield mdl-js-textfield" style="margin-top: -1%;">
										<input class="mdl-textfield__input" <#if car?? && car.registrationDate??>value="${car.registrationDate}"</#if> type="date" id="registrationDate" name="registrationDate">
									</div>
								</div>
								...
								<div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<select class="mdl-textfield__input" id="licenceCategoryId" name="licenceCategoryId">
		                                    ...
		                                    <#list licence_categories as licence_category>
												<option <#if car?? && car.licenceCategoryId?? && car.licenceCategoryId == licence_category.id>selected</#if> value="${licence_category.id}">${licence_category.name}</option>
		                                    </#list>
										</select>
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" <#if car?? && car.color??>value="${car.color}"</#if> type="text" name="color" id="color">
							...
							<div id="tech-info" hidden>
								<div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<select class="mdl-textfield__input" id="bodyTypeId" name="bodyTypeId">
		                                    ...
		                                    <#list body_types as body_type>
												<option <#if car?? && car.bodyTypeId?? && car.bodyTypeId == body_type.id>selected</#if> value="${body_type.id}">${body_type.name}</option>
		                                    </#list>
										</select>
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" <#if car?? && car.weight??>value="${car.weight}"</#if> type="number" min="0" name="weight" id="weight">
								...
								<div>
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<select class="mdl-textfield__input" id="engineTypeId" name="engineTypeId">
		                                    ...
		                                    <#list engine_types as engine_type>
												<option <#if car?? && car.engineTypeId?? && car.engineTypeId == engine_type.id>selected</#if> value="${engine_type.id}">${engine_type.name}</option>
		                                    </#list>
										</select>
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" step="0.1" <#if car?? && car.engineVolume??>value="${car.engineVolume}"</#if> type="number" min="0" name="engineVolume" id="engineVolume">
							...
							<div id="vendor-info" hidden>
								...
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<select class="mdl-textfield__input" id="brandId" name="brandId">
	                                    ...
	                                    <#list brands as brand>
											<option <#if car?? && car.brandId?? && car.brandId == brand.id>selected</#if> value="${brand.id}">${brand.name}</option>
	                                    </#list>
									</select>
								...
								<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
									<input class="mdl-textfield__input" <#if car?? && car.model??>value="${car.model}" </#if> type="text" name="model" id="model">
                    ...
                    <#else>
	                    <i class="fas fa-check-circle" style="color: green"></i> Автомобіль успішно додано
					</#if>
				</div>
			</div>
