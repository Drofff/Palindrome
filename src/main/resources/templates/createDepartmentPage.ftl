<html>
<head>
    <title>Palindrome - Add Department</title>
        ...
        <div class="page-content">
            <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 10%; margin-top: 2%;">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Додати відділ</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <form action="/admin/department/create" method="post">

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" <#if department?? && department.name??>value="${department.name}" </#if> autocomplete="off" id="name" name="name" type="text">
