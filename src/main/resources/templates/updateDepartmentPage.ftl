<html>
<head>
    <title>Palindrome - Update Department <#if department.name??>${department.name}</#if></title>
    ...
    <style>
        ...
        .demo-card-wide > .mdl-card__title {
            color: #fff;
            height: 200px;
            background: url('https://images.unsplash.com/photo-1529586073768-05e0b5a65696?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1351&q=80') center / cover;
        }
    </style>
</head>
<body>
        ...
        <div class="page-content">
            <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 10%; margin-top: 2%;">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Редагувати відділ</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <form action="/admin/department/update/${department.id}" method="post">

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" <#if department.name??>value="${department.name}" </#if> autocomplete="off" id="name" name="name" type="text">
                            <label class="mdl-textfield__label" for="name">Назва відділу</label>
                        </div>
