    ...
    <main class="mdl-layout__content">
            <div class="page-content">
                ...
                <div style="margin-left: 7%; margin-top: 3%;">
                    <a class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" href="/admin/brand/create">
                        Створити
                    </a>
                </div>
                        ...
                        <ul class="demo-list-item mdl-list">
                            <#list brands as brand>
                                <div class="demo-card-square mdl-card mdl-shadow--2dp">
                                    ...
                                    <span class="material-icons" onclick="window.location.href='/admin/brand/update/${brand.id}'" style="cursor: pointer">
                                       create
                                   </span>
                                        <span class="material-icons" onclick="delete_brand('${brand.id}', '${brand.name}')" style="cursor: pointer; margin-left: 2%;">
                                        delete
                                    </span>
                                    </div>
...
<script>
    ...
    function delete_brand(id, name) {
        var result = window.confirm('Ви впевнені, що бажаєте видалити марку \"' + name + "\"?");
        if(result) {
            var delete_uri = '/admin/brand/delete/' + id;
