<html>
<head>
    <title>Palindrome - Update Licence Category <#if licenceCategory.name??>${licenceCategory.name}</#if></title>
        ...
        <div class="page-content">
            <div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-left: 10%; margin-top: 2%;">
                <div class="mdl-card__title">
                    <h2 class="mdl-card__title-text">Редагувати категорію</h2>
                </div>
                <div class="mdl-card__supporting-text">
                    <form action="/admin/licence-category/update/${licenceCategory.id}" method="post">

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" <#if licenceCategory.name??>value="${licenceCategory.name}" </#if> autocomplete="off" id="name" name="name" type="text">
                            <label class="mdl-textfield__label" for="name">Назва категорії</label>
                        </div>
