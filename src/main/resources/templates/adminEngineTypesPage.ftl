<html>
<head>
    <title>Palindrome - Engine Types</title>
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect">
            ...
            <a href="/admin/engine-type" class="mdl-layout__tab is-active">Типи двигунів</a>
        </div>
    </header>
    <main class="mdl-layout__content">
        <div class="page-content">
            ...
            <div style="margin-left: 7%; margin-top: 3%;">
                <a class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" href="/admin/engine-type/create">
                    Створити
                </a>
            </div>

            <div style="margin-left: 9%; margin-top: 3%;">
                <#if engine_types?size gt 0>
                    <ul class="demo-list-item mdl-list">
                        <#list engine_types as engine_type>
                            <div class="demo-card-square mdl-card mdl-shadow--2dp">
                                <div class="mdl-card__supporting-text" style="text-align: right">
                                    <span class="material-icons" onclick="window.location.href='/admin/engine-type/update/${engine_type.id}'" style="cursor: pointer">
                                       create
                                   </span>
                                    <span class="material-icons" onclick="delete_engine_type('${engine_type.id}', '${engine_type.name}')" style="cursor: pointer; margin-left: 2%;">
                                        delete
                                    </span>
                                </div>
                                <div class="mdl-card__actions" style="height: 200px; text-align: center;">
                                    <h3>${engine_type.name}</h3>
                                </div>
                            </div>
                        </#list>
                    </ul>
...
<script>
    ...
    function delete_engine_type(id, name) {
        var result = window.confirm('Ви впевнені, що бажаєте видалити тип двигуна \"' + name + "\"?");
        if(result) {
            var delete_uri = '/admin/engine-type/delete/' + id;
